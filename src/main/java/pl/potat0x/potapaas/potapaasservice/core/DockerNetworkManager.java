...
final public class DockerNetworkManager {
    ...
    public Either<ErrorMessage, String> createNetwork(String name) {
    ...
    public Either<ErrorMessage, String> connectContainerToNetwork(String containerId, String networkId) {
        try {
