...
public enum DatastoreType {
    POSTGRESQL("PostgreSQL", "postgres:12.0", "5432/tcp", "postgres", "postgres"),
    MYSQL("MySQL", "mysql:8.0", "3306/tcp", "root", "mysql"),
    MARIADB("MariaDB", "bitnami/mariadb:10.3.18", "3306/tcp", "root", "mysql");
