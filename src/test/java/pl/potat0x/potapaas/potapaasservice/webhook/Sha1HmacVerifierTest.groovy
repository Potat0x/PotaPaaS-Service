...
class Sha1HmacVerifierTest extends Specification {

    def "should verify message authenticity"() {

        expect:
        new Sha1HmacVerifier(message, sha1HexDigest).isMessageAuthentic(secret) == expectedResult
        ...
        "test message"   | "sha1=bb3f1adc117ea0ed159d8e6baafb9dffe48c615a" | "test key"   | true
        "test message 2" | "sha1=b9bf5a4f63ffb89a5a08b5643e42fe499c778982" | "test key 2" | true
        "test message 2" | "sha1=c9bf5a4f63ffb89a5a08b5643e42fe499c778982" | "test key 2" | false
    }
}
